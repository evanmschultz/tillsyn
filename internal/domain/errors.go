...
var (
	...
	ErrInvalidTemplateLibrary           = errors.New("invalid template library")
	ErrInvalidTemplateLibraryScope      = errors.New("invalid template library scope")
	...
	ErrBuiltinTemplateBootstrapRequired = errors.New("builtin template bootstrap is required")
