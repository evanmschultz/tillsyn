...
func mapAuthRequestRecord(request domain.AuthRequest) AuthRequestRecord {
	...
	return AuthRequestRecord{
		...
		ApprovingPrincipalID:     request.ApprovingPrincipalID,
		ApprovingAgentInstanceID: request.ApprovingAgentInstanceID,
		ApprovingLeaseToken:      request.ApprovingLeaseToken,
	}
}
