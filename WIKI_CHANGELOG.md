...
```
## Drop <N> — <Title> (<closed_date>)

- <One-liner bullet — what changed and why it matters>
- <Additional bullets if multiple distinct changes>
```

Keep each bullet under ~150 chars. If more detail is needed, link into `LEDGER.md` for the full drop entry. This file is a scan-able index, not a narrative.
