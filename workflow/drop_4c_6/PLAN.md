...
**Closed:** 2026-05-12 (HEAD `e321d3f` on origin/main, both CI jobs green; Hylla reingest deferred — pre-existing artifact-lineage state from Drop 0 project reset blocks `--is-ancestor` incremental check, separate dev disposition required).
